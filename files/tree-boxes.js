/***************************************************************
 *
http://seil.cse.iitb.ac.in/grafana/d/2z8miu8Wz/power-data-visualization-multiple-sensors?var-power_sensor1=aravali_1&var-power_sensor2=none&var-power_sensor3=none&var-power_sensor4=none&var-power_sensor5=none&orgId=1
...
function treeBoxes(urlService, jsonData,sensorDescription)
{
	...
	var rectNode = { width : 180, height : 80, textMargin : 5 },
//		tooltip = { width : 150, height : 40, textMargin : 5 };
		tooltip = { width : 100, height : 40, textMargin : 5 };
	var i = 0,
		duration = 750,
		root;
...
//	    .text(function(d) {return 'Name: ' + d.name;})
	    ...
	    .attr('dy', '1.25em')
		.attr('class', 'wordwrap')
	   // .text(function(d) {return 'Info: ' + d.description;});
		 .text(function(d) {return null;});
	//	.text(function(d) {return '<div style="width: '+ (tooltip.width - tooltip.textMargin * 2) + 'px; height: '+ (tooltip.height - tooltip.textMargin * 2) + 'px;" class="tooltip-text wordwrap"> Info: ' + d.description +  '</div>';});
